...
// Check, if the given url actually exists in $collection, 
// to prevent errors when reloading (and re-submitting a previous post request) after deleting or moving a page.
if (array_key_exists($url, $collection)) {
	...
	// Else, if the requested url doesn't exist anymore, due to just pressing the refresh button of the browser,
	// load the home page without taking any other action.
	$url = '/';
	$page = $collection[$url];
