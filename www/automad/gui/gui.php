...
class GUI {
	...
	public function __construct() {
		...
		if ($this->user()) {
			...
			$Site = new \Automad\Core\Site(false);
	...
	private function getPageVarsInTemplate($theme, $template) {
		...
		$content = \Automad\Core\Parse::templateNestedIncludes($content, dirname($file));
		...
		$content = \Automad\Core\Parse::templateMethods($content, new \Automad\Core\Site());
