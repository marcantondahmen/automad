...
/**
 *	Header items - all needed .js and .css files. 
 */
?>
...
<script type="text/javascript" src="<?php echo AM_BASE_URL; ?>/automad/lib/jquery-file-upload/jquery.fileupload.js"></script>
<script type="text/javascript" src="<?php echo AM_BASE_URL; ?>/automad/lib/jquery-file-upload/jquery.iframe-transport.js"></script>
<script type="text/javascript" src="<?php echo AM_BASE_URL; ?>/automad/gui/gui.js"></script>
