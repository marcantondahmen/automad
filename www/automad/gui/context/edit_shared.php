			...
			<div class="col-md-8">
				...
				<div class="tab-content">
					<div id="data" class="tab-pane fade in active">
						<form class="clearfix automad-form" data-automad-handler="shared_data" role="form"></form>
					</div>
					<div id="files" class="tab-pane fade">
						...
						<form class="clearfix automad-form" data-automad-handler="files" role="form"></form>
					</div>
				</div>
