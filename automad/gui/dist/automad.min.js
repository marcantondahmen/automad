...
html:'<iframe width="500" height="300" style="display: block; width: 500px; border-bottom: 1px solid #E0E0E0; margin: 0 auto;" frameborder="0" scrolling="no" allowtransparency="true"></iframe>',height:400,width:500,id:t=>t.join("/status/")}}}(function(t){return t.editorJS=t.editorJS||{},t.editorJS}(window.Automad=window.Automad||{}));class AutomadFilelist{constructor({data:t}){var e=Automad.util.create;this.data={file:t.file||"",glob:t.glob||"*.*"},this.wrapper=document.createElement("div"),
