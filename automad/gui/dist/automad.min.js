 ...
 */!function(t,e,a){t.addVariable={selectors:{container:"#am-add-variable-container",modal:"#am-add-variable-modal",modalInput:"#am-add-variable-input",submit:"#am-add-variable-submit"},dataAttr:{errorName:"data-am-error-name",errorExists:"data-am-error-exists"},append:function(i){var o=t.addVariable,n=t.util,r=e(i.target),l=e(o.selectors.container),s=e(o.selectors.modalInput),d=s.val().replace(/[^\w\.\-]/g,"_").toLowerCase();0==e("#am-input-data-"+d).length?d?e.post("?ajax=add_variable",{name:d
},(function(t){a.modal(o.selectors.modal).hide(),s.val(""),l.append(t.html),e("#am-input-data-"+d).focus()})):t.notify.error(r.data(n.dataCamelCase(o.dataAttr.errorName))):t.notify.error(r.data(n.dataCamelCase(o.dataAttr.errorExists)))}},e(document).on("click",t.addVariable.selectors.submit,t.addVariable.append)}(window.Automad=window.Automad||{},jQuery,UIkit),function(t,e){t.blockEditor={dataAttr:"data-am-block-editor",init:function(){var a=t.blockEditor,i="["+a.dataAttr+"]",o=function(){
var t=e(this).closest(".codex-editor").find(".cdx-block, .ce-block__content").first().get(0),a=document.createElement("div");t.appendChild(a),t.removeChild(a)};e(i).each((function(){var i,o,n=e(this),r=n.data(t.util.dataCamelCase(a.dataAttr)),l=n.find("input");try{i=JSON.parse(l.val().replace(/&amp;/g,"&"))}catch(t){i={}}n.removeAttr(a.dataAttr),o=new EditorJS({holder:r,logLevel:"ERROR",data:i,tools:{paragraph:{class:AutomadParagraph,inlineToolbar:!0},header:{class:Header,shortcut:"CMD+SHIFT+H",
inlineToolbar:!0,config:{levels:[1,2,3,4,5,6],defaultLevel:2}},lists:{class:List,inlineToolbar:!0},table:{class:Table,inlineToolbar:!0},quote:{class:Quote,inlineToolbar:!0},delimiter:AutomadDelimiter,image:AutomadImage,gallery:AutomadGallery,slider:AutomadSlider,buttons:{class:AutomadButtons,inlineToolbar:["italic","bold","underline","editorJSStyle"]},pagelist:AutomadPagelist,filelist:AutomadFilelist,code:AutomadTextareaCode,raw:AutomadTextareaRaw,mail:AutomadMail,snippet:AutomadSnippet,embed:{
class:Embed,config:{services:t.editorJS.embedServices}},underline:Underline,inlineCode:{class:InlineCode,shortcut:"CMD+SHIFT+M"},marker:{class:Marker},editorJSStyle:{class:EditorJSStyle,shortcut:"CMD+SHIFT+S"},editorJSInspector:EditorJSInspector},onChange:function(){o.save().then((function(t){var e=JSON.stringify(t.blocks);try{var a=JSON.stringify(JSON.parse(l.val()).blocks)}catch(t){a=""}a!=e&&l.val(JSON.stringify(t)).trigger("change")}))},onReady:function(){
n.find(".codex-editor__redactor").removeAttr("style"),new DragDrop(o),new Undo({editor:o})}})})),e(document).on("click",".ce-settings__plugin-zone .cdx-settings-button",o),e(document).on("change keyup",".cdx-input, .ce-block input, .ce-block select",o),e(window).click((function(){e(".ce-block--focused").removeClass("ce-block--focused")})),e(document).on("blur",".ce-block--focused [contenteditable]",(function(t){t.stopPropagation()}))}},e(document).on("ajaxComplete",(function(e,a,i){
...
var a=t.copyResized,i=a.dataAttr,o=a.selectors,n=e(this).closest("["+i.fileInfo+"]").data(t.util.dataCamelCase(i.fileInfo)),r=e(o.modal);e(o.filename).val(n.filename),e(o.width).val(n.img.originalWidth),e(o.height).val(n.img.originalHeight),r.off("hide.uk.modal.automad.copyResized"),r.on("hide.uk.modal.automad.copyResized",a.destroy)},submit:function(i){var o=t.copyResized,n=o.selectors,r=e(i.target),l={url:e(n.modal).data(t.util.dataCamelCase(o.dataAttr.url)),filename:e(n.filename).val(),
width:e(n.width).val(),height:e(n.height).val(),crop:Number(e(n.crop).is(":checked"))};r.prop("disabled",!0),e.post("?ajax=copy_resized",l,(function(i){r.prop("disabled",!1),i.error&&t.notify.error(i.error),i.success&&t.notify.success(i.success),e(n.modal).on("hide.uk.modal.automad.copyResized",(function(){o.destroy(),e(n.modal).closest("form").empty().submit()})),a.modal(n.modal).hide()}),"json")}},e(document).on("click",'a[href="'+t.copyResized.selectors.modal+'"]',t.copyResized.init),
...
;t.find("[data-am-u-timepicker]").val(""),t.find("[data-am-u-datepicker]").val("").trigger("change")}))},today:function(){var t=new Date,e=t.getMonth()+1,a=t.getDate();return t.getFullYear()+"-"+((""+e).length<2?"0":"")+e+"-"+((""+a).length<2?"0":"")+a},update:{date:function(a){var i=e(a.target),o=t.datetime,n=i.closest(o.selector),r=n.find('input[type="hidden"]'),l=i.val(),s=n.find("[data-am-u-timepicker]");time=s.val(),l?(time||(time="12:00",s.val(time)),r.val(l+" "+time+":00")):(r.val(""),
s.val("")),r.trigger("change")},time:function(a){var i=e(a.target),o=t.datetime,n=i.closest(o.selector),r=n.find('input[type="hidden"]'),l=i.val(),s=n.find("[data-am-u-datepicker]");date=s.val(),l||(l="12:00",i.val(l)),date||(date=o.today(),s.val(date)),r.val(date+" "+l+":00").trigger("change")}}},t.datetime.init()}(window.Automad=window.Automad||{},jQuery),function(t,e){t.debug={init:function(){e(document).ajaxComplete((function(t,a,i){
...
var a=t.editFileInfo,i=t.util,o=a.dataAttr,n=a.selectors,r=e(this).closest("["+o.fileInfo+"]").data(i.dataCamelCase(o.fileInfo)),l=e(n.modal);r.img?e(n.img).attr("src",r.img.src).attr("width",r.img.width).attr("height",r.img.height):e(n.icon).attr(o.ext,r.extension).append(e("<i></i>",{class:"am-u-icon-file-o am-files-icon-"+r.extension})),e(n.oldName).val(r.filename),e(n.newName).val(r.filename),e(n.caption).val(r.caption).trigger("keyup"),e(n.download).attr("href",r.download),
l.off("hide.uk.modal.automad.editFileInfo"),l.on("hide.uk.modal.automad.editFileInfo",a.destroy)},submit:function(i){var o=t.editFileInfo,n=o.selectors,r=e(i.target),l={url:e(n.modal).data(t.util.dataCamelCase(o.dataAttr.url)),"old-name":e(n.oldName).val(),"new-name":e(n.newName).val(),caption:e(n.caption).val()};r.prop("disabled",!0),e.post("?ajax=edit_file_info",l,(function(i){r.prop("disabled",!1),i.error&&t.notify.error(i.error),e(n.modal).on("hide.uk.modal.automad.editFileInfo",(function(){
...
"hide.uk.modal.automad.form":function(){e(this).find("form").each((function(){var a=e(this).data(t.util.dataCamelCase(t.form.dataAttr.handler));e("html").removeClass(t.form.unsavedClassPrefix+a),this.reset()}))}})}},t.form.init()}(window.Automad=window.Automad||{},jQuery,UIkit),function(t,e,a){a.on("beforeready.uk.dom",(function(){e.extend(a.components.formSelect.prototype.defaults,{activeClass:""})}))}(window.Automad=window.Automad||{},jQuery,UIkit),function(t,e){t.fullscreen={classes:{
fullscreenWrapper:"am-fullscreen",fullscreenHtml:"am-fullscreen-page"},dataAttr:{toggle:"data-am-fullscreen"},init:function(){var a=t.fullscreen,i=a.classes;e(document).on("click","["+a.dataAttr.toggle+"]",(function(){var t=e("html");t.hasClass(i.fullscreenHtml)?(t.removeClass(i.fullscreenHtml),e("."+i.fullscreenWrapper).removeClass(i.fullscreenWrapper)):(t.addClass(i.fullscreenHtml),e(this).parent().addClass(i.fullscreenWrapper)),e(window).trigger("resize"),setTimeout((function(){
e(window).trigger("resize")}),500)}))}},t.fullscreen.init()}(window.Automad=window.Automad||{},jQuery),function(t,e,a){t.import={selectors:{modal:"#am-import-modal",button:"#am-import-modal .am-u-form button",input:'#am-import-modal [name="importUrl"]'},dataAttr:{url:"data-am-url"},init:function(){var i=t.import;e(document).on("click",i.selectors.button,(function(){var o=e(i.selectors.modal),n=e(i.selectors.input).val(),r=o.closest("form"),l=o.data(t.util.dataCamelCase(i.dataAttr.url))
;e.post("?ajax=import",{url:l,importUrl:n},(function(e){e.error?t.notify.error(e.error):(o.on("hide.uk.modal.automad.import",(function(){o.off("automad.import"),r.empty().submit()})),a.modal(i.selectors.modal).hide())}),"json")}))}},t.import.init()}(window.Automad=window.Automad||{},jQuery,UIkit),function(t,e){t.inPage={selectors:{modal:"#am-inpage-edit-modal",fields:"#am-inpage-edit-fields",menubar:".am-inpage-menubar",dragHandle:".am-drag-handle"},dataAttr:{content:"data-am-inpage-content",
handler:"data-am-inpage-handler"},modal:{init:function(){var a=e(this),i=t.inPage,o=t.util,n=a.data(o.dataCamelCase(i.dataAttr.content)),r=e(i.selectors.modal).find("form"),l=r.data(o.dataCamelCase(i.dataAttr.handler)),s=e("<i></i>",{class:"am-u-icon-circle-o-notch am-u-icon-spin am-u-icon-small"}).appendTo(r);e(i.selectors.fields).remove(),e.post(l,n,(function(t){if(t.html){var a=e(t.html).appendTo(r).hide();setTimeout((function(){e(window).resize()}),400),setTimeout((function(){s.remove(),
a.fadeIn(300,(function(){e(window).resize(),a.find(".am-u-form-controls, textarea, [contenteditable]").first().focus()}))}),600)}}),"json")},submit:function(a){a.preventDefault();var i=e(a.target),o=i.data(t.util.dataCamelCase(t.inPage.dataAttr.handler)),n=i.serializeArray();e.post(o,n,(function(t){t.redirect&&(window.location.href=t.redirect)}),"json")}},menubar:{init:function(){var a=t.inPage.selectors;e(a.menubar).draggabilly({handle:a.dragHandle})}}},
e(document).on("click",'[href="'+t.inPage.selectors.modal+'"]',t.inPage.modal.init),e(document).on("submit","["+t.inPage.dataAttr.handler+"]",t.inPage.modal.submit),e(document).on("ready",t.inPage.menubar.init)}(window.Automad=window.Automad||{},jQuery),function(t){t(document).ready((function(){t("#am-no-js").remove()}))}(jQuery),function(t,e){t.keyCombos={init:function(){e(window).bind("keydown",(function(t){if(t.ctrlKey||t.metaKey)switch(String.fromCharCode(t.which).toLowerCase()){case"s":
t.preventDefault(),e('.am-navbar [data-am-submit], .am-inpage .am-u-open [type="submit"]').click()}if((t.ctrlKey||t.metaKey)&&t.shiftKey)switch(String.fromCharCode(t.which).toLowerCase()){case" ":t.preventDefault(),e('.am-navbar-search [name="query"]').focus()}}))}},t.keyCombos.init()}(window.Automad=window.Automad||{},jQuery),function(t,e,a){t.link={dataAttr:{form:"data-am-link",field:"data-am-link-field"},modalSelector:"#am-link-modal",init:function(){var a=t.link,i=a.dataAttr
;e(document).on("click","["+i.field+"] button",(function(){a.click(this)}))},click:function(a){var i=e(a).parent().find("input");t.link.dialog(i,(function(t){i.val(t).trigger("change")}))},dialog:function(i,o){var n=a.modal(t.link.modalSelector);n.show().find("input").val(""),n.on("click.automad.link",".am-u-form button",(function(){var t;t=e(this).parent().find("input").val(),n.isActive()&&("function"==typeof o&&o(t),n.hide())})),n.on("hide.uk.modal.automad.link",(function(){i.focus(),
n.off(".automad.link")}))},autocomplete:function(){var i=t.link.dataAttr.form,o=e("["+i+"]").first(),n=o.data(t.util.dataCamelCase(i));o.length>0&&e.post(n,(function(t){var e=o.find(".am-u-autocomplete").first(),i={source:t,minLength:1};a.autocomplete(e,i).on("selectitem.uk.autocomplete",(function(t,e){o.find("input").val(e.value),o.find("button").click()}))}),"json")}},t.link.init(),e(document).on("ready",t.link.autocomplete)}(window.Automad=window.Automad||{},jQuery,UIkit),
/*!
...
t.packages.composerDone(),t.packages.get(),t.packages.filter()}},e(document).on("ready",t.packages.init)}(window.Automad=window.Automad||{},jQuery,UIkit),function(t){t(document).on("click",".am-remove-parent",(function(){var e=t(this).parent();e.find("input, textarea").trigger("change"),e.remove(),t(document).trigger("count.automad")}))}(jQuery),function(t,e){t.scrollPosition={init:function(){var t=e(document),a=e("html");e(window).scroll((function(){this.scrolling&&clearTimeout(this.scrolling),
this.scrolling=setTimeout((function(){e(this).trigger("scrolled.automad")}),10)})),e(window).on("load scrolled.automad",(function(){var e=t.scrollTop(),i="am-scrolled";e>30?a.addClass(i):a.removeClass(i),e>60?a.addClass("am-scrolled-secondary"):a.removeClass("am-scrolled-secondary")}))}},e(document).ready(t.scrollPosition.init)}(window.Automad=window.Automad||{},jQuery),function(t,e){t.scrollbars={defaults:{scrollToItem:!1},dataAttr:"data-am-scroll-box",init:function(){
var a=t.scrollbars,i=t.util;e("["+a.dataAttr+"]").each((function(){var t=e(this),o=t.data(i.dataCamelCase(a.dataAttr)),n=e.extend({},a.defaults,o);if(t.am_mCustomScrollbar({scrollbarPosition:"inside",theme:"minimal-dark",autoHideScrollbar:!0,scrollInertia:50,scrollButtons:{enable:!1},callbacks:{onScroll:function(){t.trigger("scrolled.automad")},onUpdate:function(){t.trigger("scrolled.automad")}}}),n.scrollToItem){var r=t.find(n.scrollToItem);r.length&&setTimeout((function(){
r.offset().top+180>e(window).height()&&t.am_mCustomScrollbar("scrollTo",(function(){return r.offset().top-e(window).height()+180}),{scrollInertia:200})}),150)}}))}},e(document).ready(t.scrollbars.init)}(window.Automad=window.Automad||{},jQuery),function(t,e,a){t.search={selector:"[data-am-search]",submitForm:function(t){t.preventDefault();var a=e(t.target).closest("form");setTimeout((function(){a.submit()}),50)}},e(document).on("ready",(function(){
...
t.selectImage={dataAttr:{field:"data-am-select-image-field"},modalSelector:"#am-select-image-modal",init:function(){var a=t.selectImage,i=a.dataAttr;e(document).on("click","["+i.field+"] button",(function(){var t=e(this).parent().find("input");a.dialog(t,!1,(function(e){t.val(e).trigger("change")}))}))},dialog:function(i,o,n){var r=t.selectImage.modalSelector,l=a.modal(r),s=function(t,e){if(l.isActive()){if(o&&"label"==e.tagName.toLowerCase()){
var a=l.find('[name="width"]').val(),i=l.find('[name="height"]').val();a&&i&&(t=t+"?"+a+"x"+i)}"function"==typeof n&&n(t),l.hide()}};e(r).removeClass("am-select-image-resize-hide"),o||e(r).addClass("am-select-image-resize-hide");var d=e(".am-inpage");if(d.length>0){var c=d.find('[name="context"]').val();l.find("form").data("amUrl",c)}l.show(),l.on("click.automad.selectImage","form button",(function(){s(e(this).parent().find("input").val(),this)})),
l.on("click.automad.selectImage","form label",(function(){s(e(this).find("input").val(),this)})),l.on("hide.uk.modal.automad.selectImage",(function(){i&&i.focus(),l.off(".automad.selectImage")}))}},t.selectImage.init()}(window.Automad=window.Automad||{},jQuery,UIkit),function(t,e){t.siteTree={class:{active:"am-u-active",iconOpen:"am-tree-icon-open",iconClose:"am-tree-icon-close",toggle:"am-tree-toggle"},dataAttr:"data-am-tree",urlAsValue:function(a,i){
var o=t.siteTree,n=a.find('a[href^="?"]'),r=a.find("."+o.class.active+' > a[href^="?"]');r.length>0&&i.val(decodeURIComponent(r.attr("href").split("=")[1])),n.click((function(t){t.preventDefault();var n=e(this),r=n.parent(),l=decodeURIComponent(n.attr("href").split("=")[1]);a.find("."+o.class.active).removeClass(o.class.active),r.addClass(o.class.active),r.find("> a").has("."+o.class.iconOpen).click(),i.val(l).trigger("change")}))},init:function(){var a=t.siteTree
...
["?ajax=users","?ajax=add_user","?ajax=edit_headless_template","?ajax=reset_headless_template","?ajax=update_config","?ajax=get_packages"].includes(a.url)&&i.get()}))}},t.status.init()}(window.Automad=window.Automad||{},jQuery),function(t,e,a){t.switcher={dataAttr:{switcher:"data-am-u-switcher",tab:"data-am-tab"},getActiveTab:function(){if(window.location.hash){var a=window.location.hash.substr(1);return e.isNumeric(a)?parseInt(a):e("["+t.switcher.dataAttr.tab+'="'+a+'"]').index()}return 0}},
a.on("beforeready.uk.dom",(function(){e.extend(a.components.switcher.prototype.defaults,{active:t.switcher.getActiveTab()})})),e(window).on("hashchange",(function(){var a=e("["+t.switcher.dataAttr.switcher+"]"),i=a.children(".am-u-active"),o=t.switcher.getActiveTab();i.index()!=o&&o>0&&a.children("button").eq(o).click()})),e(document).on("ready",(function(){e("["+t.switcher.dataAttr.switcher+"]").on("show.uk.switcher",(function(e,a){
window.location.hash=a.data(t.util.dataCamelCase(t.switcher.dataAttr.tab))}))}))}(window.Automad=window.Automad||{},jQuery,UIkit),function(t,e,a){t.tags={containerId:"am-taggle",inputId:"am-input-data-tags",dataAttr:"data-am-tags",init:function(){var i=t.tags,o=e("#"+i.containerId);if(o.length){var n=t.util,r=e("#"+i.inputId),l=o.data(n.dataCamelCase(i.dataAttr)),s=new Taggle(i.containerId,{tags:l.tags,preserveCase:!0,submitKeys:[188,9],focusInputOnContainerClick:!0,placeholder:"",saveOnBlur:!1,
clearOnBlur:!0,onTagAdd:function(){d(),r.trigger("change")},onTagRemove:function(){d(),r.trigger("change")}}),d=function(){r.val(s.getTagValues().sort().join(", "))};d(),o.removeAttr("id"),$inputWrapper=e(s.getInput()).wrap('<div class="am-u-autocomplete"></div>').parent(),$autocomplete=a.autocomplete($inputWrapper,{source:l.autocomplete,minLength:1}),$autocomplete.on("selectitem.uk.autocomplete",(function(t,e,a){s.add(e.value)})),e(s.getInput()).on("change",(function(){e(this).val("")}))}}},
e(document).on("ajaxComplete",t.tags.init)}(window.Automad=window.Automad||{},jQuery,UIkit),function(t,e){t.textarea={selector:"textarea.am-u-form-controls:not([data-am-u-markdowneditor]), textarea.cdx-input",handleTabs:function(t){if(9===t.keyCode){t.preventDefault();var a=this.selectionStart,i=this.selectionEnd,o=e(t.target),n=o.val();o.val(n.substring(0,a)+"\t"+n.substring(i)),this.selectionStart=this.selectionEnd=a+1}},init:function(){var a=t.textarea,i=e(document)
;i.on("keyup focus focusout update.automad.textarea",a.selector,a.resize),i.on("drop cut paste",a.selector,(function(t){var a=e(t.target);setTimeout((function(t){a.trigger("update.automad.textarea")}),50)})),i.ajaxComplete((function(){e(a.selector).trigger("update.automad.textarea")})),i.on("ready",(function(){e(a.selector).trigger("update.automad.textarea")})),i.on("click",".am-u-accordion-title",(function(){setTimeout((function(){e(a.selector).trigger("update.automad.textarea")}),50)})),
e(window).resize((function(){e(a.selector).trigger("update.automad.textarea")})),i.on("keydown",a.selector,a.handleTabs)},resize:function(t){var a=e(t.target),i=a.val().replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\n/g,"<br />"),o=e("<div></div>").appendTo("body").hide().width(a.width()).html(i+" ").css({"white-space":"pre-wrap","word-wrap":"break-word","overflow-wrap":"break-word","font-family":a.css("font-family"),"font-size":a.css("font-size"),"line-height":a.css("line-height"),
"letter-spacing":a.css("letter-spacing")});a.height(o.height()),o.remove()}},t.textarea.init()}(window.Automad=window.Automad||{},jQuery),function(t,e){t.toggle={labelDataAttr:"data-am-toggle",class:{active:"am-u-active"},checkbox:function(a){t.toggle.update(e(a.target))},init:function(){e("["+t.toggle.labelDataAttr+"] input").each((function(){t.toggle.update(e(this))}))},radio:function(a){e('input[name="'+e(a.target).attr("name")+'"]').each((function(){t.toggle.update(e(this))}))},
update:function(a){var i=t.toggle,o=a.parent(),n=o.data(t.util.dataCamelCase(i.labelDataAttr));if(a.is(":checked")?o.addClass(i.class.active):o.removeClass(i.class.active),n){var r=e(n);a.is(":checked")?r.addClass(i.class.active):r.removeClass(i.class.active)}}},e(document).on("change","["+t.toggle.labelDataAttr+'] [type="checkbox"]',t.toggle.checkbox),e(document).on("change","["+t.toggle.labelDataAttr+'] [type="radio"]',t.toggle.radio),e(document).on("ready ajaxComplete",t.toggle.init)
...
var a=e("[data-am-url]").data("amUrl");return void 0===a&&(a=""),t.includes("://")?t:t.startsWith("/")?"."+t:"."+a+"/"+t}}}(window.Automad=window.Automad||{},jQuery),function(t,e){e.defineExtension("AutomadImage",(function(){var e=this;t.selectImage.dialog(e,!0,(function(t){e.replaceRange("![]("+t+")\n",e.getCursor())}))}))}(window.Automad=window.Automad||{},CodeMirror),function(t,e){e.defineExtension("AutomadLink",(function(){var e=this;t.link.dialog(e,(function(t){var a=e.getSelection()
;a||(a=t),e.replaceSelection("["+a+"]("+t+")")}))}))}(window.Automad=window.Automad||{},CodeMirror);class AutomadButtons{constructor({data:t,api:e}){var a=Automad.util.create;this.api=e,this.data={primaryText:t.primaryText||"",primaryLink:t.primaryLink||"",secondaryText:t.secondaryText||"",secondaryLink:t.secondaryLink||"",alignment:t.alignment||"left"},this.wrapper=document.createElement("div"),this.wrapper.classList.add("am-u-panel","am-u-panel-box"),
...
title:"Delimiter"}}}!function(t){t.embedServices={youtube:!0,codepen:!0,vimeo:!0,imgur:!0,instagram:!0,dailymotion:{regex:/https?:\/\/www\.dailymotion\.com\/video\/(\w+)(\?.*?)?$/,embedUrl:"https://www.dailymotion.com/embed/video/<%= remote_id %>/",html:'<iframe width="640" height="360" frameborder="0" allowFullScreen></iframe>',height:360,width:640},giphy:{regex:/https?:\/\/giphy\.com\/\gifs\/(?:[^\/]*\-)?([a-zA-Z0-9]+)$/,embedUrl:"https://giphy.com/embed/<%= remote_id %>/",
...
embedUrl:"https://w.soundcloud.com/player/?url=<%= remote_id %>",html:'<iframe height="180" scrolling="no" frameborder="no" allowtransparency="true" allowfullscreen="true" style="width: 100%;"></iframe>',height:180,width:0}}}(function(t){return t.editorJS=t.editorJS||{},t.editorJS}(window.Automad=window.Automad||{}));class AutomadFilelist{constructor({data:t}){var e=Automad.util.create;this.data={file:t.file||"",glob:t.glob||"*.*"},this.wrapper=document.createElement("div"),
...
}}render(){return this.wrapper}save(){return{file:this.inputs.file.value,glob:this.inputs.glob.innerHTML}}}class AutomadGallery{constructor({data:t,api:e}){var a=Automad.util.create;this.api=e,this.data={globs:t.globs||"*.jpg, *.png, *.gif",width:t.width||250,stretched:void 0===t.stretched||t.stretched,cleanBottom:void 0===t.cleanBottom||t.cleanBottom},this.inputs={globs:a.editable(["cdx-input"],"Enter one or more glob patterns",this.data.globs),
width:a.editable(["cdx-input"],"Image width in px",this.data.width)};var i=document.createElement("div"),o=document.createElement("div");i.innerHTML=AutomadGallery.toolbox.icon,i.classList.add("am-block-icon"),o.innerHTML=AutomadGallery.toolbox.title,o.classList.add("am-block-title"),this.wrapper=document.createElement("div"),this.wrapper.classList.add("am-u-panel","am-u-panel-box"),this.wrapper.appendChild(i),this.wrapper.appendChild(o),this.wrapper.appendChild(document.createElement("hr")),
this.wrapper.appendChild(a.label("Pattern")),this.wrapper.appendChild(this.inputs.globs),this.wrapper.appendChild(a.label("Image Width")),this.wrapper.appendChild(this.inputs.width),this.settings=[{name:"stretched",
...
return this.wrapper}save(){return Object.assign(this.data,{globs:this.inputs.globs.innerHTML.replace(/&nbsp;/g,""),width:parseInt(this.inputs.width.innerHTML)})}renderSettings(){var t=document.createElement("div"),e=this;return t.classList.add("cdx-settings-1-2"),this.settings.forEach((function(a){var i=document.createElement("div");i.classList.add("cdx-settings-button"),i.classList.toggle("cdx-settings-button--active",e.data[a.name]),i.innerHTML=a.icon,t.appendChild(i),
i.addEventListener("click",(function(){e.toggleTune(a.name),i.classList.toggle("cdx-settings-button--active")}))})),t}toggleTune(t){this.data[t]=!this.data[t],"stretched"==t&&this.api.blocks.stretchBlock(this.api.blocks.getCurrentBlockIndex(),this.data.stretched)}static get sanitize(){return{globs:!1,width:!1}}}class AutomadImage{constructor({data:t,api:e}){this.api=e,this.data={url:t.url||"",caption:t.caption||"",stretched:void 0!==t.stretched&&t.stretched},
this.wrapper=document.createElement("div"),this.wrapper.classList.add("cdx-block"),this.img=document.createElement("img"),this.caption=Automad.util.create.editable(["cdx-input"],"Enter a caption",this.data.caption),this.wrapper.appendChild(this.img),this.wrapper.appendChild(this.caption),this.button=document.createElement("div"),this.button.innerHTML='<i class="am-u-icon-image am-u-icon-small"></i>&nbsp;&nbsp;Select Image',
...
}}static get sanitize(){return{type:!1,matchUrl:!1,filter:!1,template:!1,limit:!1,sortKey:!1,sortOrder:!1,file:!1}}render(){return this.wrapper}save(){return{type:this.inputs.type.value,matchUrl:this.inputs.matchUrl.innerHTML,filter:this.inputs.filter.innerHTML,template:this.inputs.template.innerHTML,limit:this.inputs.limit.innerHTML,sortKey:this.inputs.sortKey.innerHTML,sortOrder:this.inputs.sortOrder.value,file:this.inputs.file.value}}}class AutomadParagraph{constructor({data:t,api:e}){
var a=void 0!==t.large&&t.large;this.api=e,this._CSS={block:this.api.styles.block,wrapper:"ce-paragraph",large:"am-paragraph-large"},this._data={},this.onKeyUp=this.onKeyUp.bind(this),this.input=this.drawView(a),this.data={text:t.text||"",large:a},this.settings=[{name:"large",
...
height:a.editable(["cdx-input"],"Image height in px",this.data.height)};var i=document.createElement("div"),o=document.createElement("div"),n=document.createElement("ul"),r=document.createElement("li"),l=document.createElement("li");i.innerHTML=AutomadSlider.toolbox.icon,i.classList.add("am-block-icon"),o.innerHTML=AutomadSlider.toolbox.title,o.classList.add("am-block-title"),n.classList.add("am-u-grid","am-u-grid-width-medium-1-2"),r.appendChild(a.label("Image Width")),
r.appendChild(this.inputs.width),l.appendChild(a.label("Image Height")),l.appendChild(this.inputs.height),n.appendChild(r),n.appendChild(l),this.wrapper=document.createElement("div"),this.wrapper.classList.add("am-u-panel","am-u-panel-box"),this.wrapper.appendChild(i),this.wrapper.appendChild(o),this.wrapper.appendChild(document.createElement("hr")),this.wrapper.appendChild(a.label("Pattern")),this.wrapper.appendChild(this.inputs.globs),this.wrapper.appendChild(n),this.settings=[{name:"stretched",
icon:'<svg width="17" height="10" viewBox="0 0 17 10"><path d="M13.568 5.925H4.056l1.703 1.703a1.125 1.125 0 0 1-1.59 1.591L.962 6.014A1.069 1.069 0 0 1 .588 4.26L4.38.469a1.069 1.069 0 0 1 1.512 1.511L4.084 3.787h9.606l-1.85-1.85a1.069 1.069 0 1 1 1.512-1.51l3.792 3.791a1.069 1.069 0 0 1-.475 1.788L13.514 9.16a1.125 1.125 0 0 1-1.59-1.591l1.644-1.644z"/></svg>'},{name:"dots",
icon:'<svg width="17px" height="10px" viewBox="0 0 17 10"><circle cx="2.0" cy="5" r="2.0"/><circle cx="8.5" cy="5" r="2.0"/><circle cx="15.0" cy="5" r="2.0"/></svg>'},{name:"autoplay",
...
this.wrapper.classList.add("am-u-panel","am-u-panel-box"),
this.wrapper.innerHTML=`\n\t\t\t<div class="am-block-icon">${AutomadSnippet.toolbox.icon}</div>\n\t\t\t<div class="am-block-title">${AutomadSnippet.toolbox.title}</div>\n\t\t\t<hr>\n\t\t\t${e.label("Select Snippet",["am-block-label","am-u-margin-top-remove"]).outerHTML}\n\t\t\t<div class="am-block-file-select am-u-form-select am-u-button am-u-text-left am-u-width-1-1" data-am-u-form-select>\n\t\t\t\t<i class="am-u-icon-file"></i>&nbsp;\n\t\t\t\t<span></span>\n\t\t\t\t${e.select(["am-block-file"],window.AutomadBlockTemplates.snippets,this.data.file).outerHTML}\n\t\t\t</div>\n\t\t`,
this.inputs={file:this.wrapper.querySelector(".am-block-file")}}static get toolbox(){return{title:"Template Snippet",
