...
}).insertAfter(r.parent()),c=l.find(".am-u-modal-footer");r.empty(),a(o.selectors.fields).remove(),a.post(s,i,function(t){if(t.html){var e=a(t.html).insertBefore(c).hide(),o=e.find('[name="context"]').val();r.text(o),setTimeout(function(){a(window).resize()},400),setTimeout(function(){u.remove(),e.fadeIn(300,function(){a(window).resize(),e.find(".am-u-form-controls, textarea").focus()})},600)}},"json")},submit:function(e){e.preventDefault()
;var o=a(e.target),n=o.data(t.util.dataCamelCase(t.inPage.dataAttr.handler)),i=o.serializeArray();a.post(n,i,function(a){a.debug&&t.debug.log(n,a.debug),a.redirect&&(window.location.href=a.redirect)},"json")}},menubar:{init:function(){var e=t.inPage.selectors;a(e.menubar).draggabilly({handle:e.dragHandle})}}},a(document).on("click",'[href="'+t.inPage.selectors.modal+'"]',t.inPage.modal.init),a(document).on("submit","["+t.inPage.dataAttr.handler+"]",t.inPage.modal.submit),
a(document).on("ready",t.inPage.menubar.init)}(window.Automad=window.Automad||{},jQuery),function(t){t(document).ready(function(){t("#am-no-js").remove()})}(jQuery),function(t,a){t.keyCombos={init:function(){a(window).bind("keydown",function(t){if(t.ctrlKey||t.metaKey)switch(String.fromCharCode(t.which).toLowerCase()){case"s":t.preventDefault(),a('.am-navbar [data-am-submit], .am-inpage .am-u-open [type="submit"]').click();break;case" ":t.preventDefault(),
a('.am-navbar-search [name="query"]').focus()}})}},t.keyCombos.init()}(window.Automad=window.Automad||{},jQuery),function(t,a,e){t.notify={error:function(t){e.notify(t,{timeout:0,pos:"top-right",status:"danger"})},success:function(t){e.notify(t,{timeout:3e3,pos:"top-right",status:"success"})}}}(window.Automad=window.Automad||{},jQuery,UIkit),function(t){t(document).on("click",".am-remove-parent",function(){var a=t(this).parent();a.find("input, textarea").trigger("change"),a.remove(),
t(document).trigger("count.automad")})}(jQuery),function(t,a){t.scrollPosition={init:function(){var t=a(document),e=a("html");a(window).scroll(function(){this.scrolling&&clearTimeout(this.scrolling),this.scrolling=setTimeout(function(){a(this).trigger("scrolled.automad")},10)}),a(window).on("load scrolled.automad",function(){var a=t.scrollTop(),o="am-scrolled";a>30?e.addClass(o):e.removeClass(o)})}},a(document).ready(t.scrollPosition.init)}(window.Automad=window.Automad||{},jQuery),
function(t,a){t.scrollbars={defaults:{scrollToItem:!1},dataAttr:"data-am-scroll-box",init:function(){var e=t.scrollbars,o=t.util;a("["+e.dataAttr+"]").each(function(){var t=a(this),n=t.data(o.dataCamelCase(e.dataAttr)),i=a.extend({},e.defaults,n);if(t.mCustomScrollbar({scrollbarPosition:"inside",theme:"minimal-dark",autoHideScrollbar:!0,scrollInertia:50,scrollButtons:{enable:!1},callbacks:{onScroll:function(){t.trigger("scrolled.automad")},onUpdate:function(){t.trigger("scrolled.automad")}}}),
i.scrollToItem){var d=t.find(i.scrollToItem);d.length&&setTimeout(function(){d.offset().top+180>a(window).height()&&t.mCustomScrollbar("scrollTo",function(){return d.offset().top-a(window).height()+180},{scrollInertia:200})},150)}})}},a(document).ready(t.scrollbars.init)}(window.Automad=window.Automad||{},jQuery),function(t,a){t.siteTree={class:{active:"am-u-active",iconOpen:"am-tree-icon-open",iconClose:"am-tree-icon-close",toggle:"am-tree-toggle"},dataAttr:"data-am-tree",
