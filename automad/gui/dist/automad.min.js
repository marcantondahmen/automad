...
;i.on("drop cut paste keydown",`${s} input${l}, \n\t\t\t\t ${s} textarea${l}, \n\t\t\t\t .am-inpage form *`,r),i.on("change",`${s} [type="hidden"]${l}, \n\t\t\t\t ${s} [type="checkbox"]${l},\n\t\t\t\t ${s} [type="color"]${l},\n\t\t\t\t ${s} select${l},  \n\t\t\t\t .am-inpage form *`,r),i.on("submit","["+n.handler+"], .am-inpage form",(function(){var a=e(this).data(t.util.dataCamelCase(n.handler));e("html").removeClass(o.unsavedClassPrefix+a)})),window.onbeforeunload=function(){
...
window.location.hash=a.data(t.util.dataCamelCase(t.switcher.dataAttr.tab))}))}))}(window.Automad=window.Automad||{},jQuery,UIkit),function(t,e,a){t.tags={containerId:"am-taggle",inputId:"am-input-data-tags",dataAttr:"data-am-tags",init:function(){var i=t.tags,o=e("#"+i.containerId);if(o.length){var n=t.util,r=e("#"+i.inputId),s=o.data(n.dataCamelCase(i.dataAttr)),l=new Taggle(i.containerId,{tags:s.tags,preserveCase:!0,submitKeys:[188,9],focusInputOnContainerClick:!0,placeholder:"",saveOnBlur:!1,
clearOnBlur:!0,onTagAdd:function(){d(),r.trigger("change")},onTagRemove:function(){d(),r.trigger("change")}}),d=function(){r.val(l.getTagValues().sort().join(", "))};d(),o.removeAttr("id"),$inputWrapper=e(l.getInput()).wrap('<div class="am-u-autocomplete"></div>').parent(),$autocomplete=a.autocomplete($inputWrapper,{source:s.autocomplete,minLength:1}),$autocomplete.on("selectitem.uk.autocomplete",(function(t,e,a){l.add(e.value)})),e(l.getInput()).on("change",(function(){e(this).val("")}))}}},
...
var a=e("[data-am-url]").data("amUrl");return void 0===a&&(a=""),t.includes("://")?t:t.startsWith("/")?"."+t:"."+a+"/"+t}}}(window.Automad=window.Automad||{},jQuery),function(t,e,a){a.defineExtension("AutomadImage",(function(){var a=this;t.selectImage.dialog(a,!0,(function(t){a.replaceRange("![]("+t+")\n",a.getCursor()),e(a.getTextArea()).trigger("keydown")}))}))}(window.Automad=window.Automad||{},jQuery,CodeMirror),function(t,e,a){a.defineExtension("AutomadLink",(function(){var a=this
;t.link.dialog(a,(function(t){var i=a.getSelection();i||(i=t),a.replaceSelection("["+i+"]("+t+")"),e(a.getTextArea()).trigger("keydown")}))}))}(window.Automad=window.Automad||{},jQuery,CodeMirror);class AutomadButtons{constructor({data:t,api:e}){var a=Automad.util.create;this.api=e,this.data={primaryText:t.primaryText||"",primaryLink:t.primaryLink||"",secondaryText:t.secondaryText||"",secondaryLink:t.secondaryLink||"",alignment:t.alignment||"left"},this.wrapper=document.createElement("div"),
...
this.wrapper.appendChild(a.label("Pattern")),this.wrapper.appendChild(this.inputs.globs),this.wrapper.appendChild(a.label("Image Width")),this.wrapper.appendChild(this.inputs.width),this.settings=[{name:"stretched",title:"Full Width",
...
var a=void 0!==t.large&&t.large;this.api=e,this._CSS={block:this.api.styles.block,wrapper:"ce-paragraph",large:"am-paragraph-large"},this._data={},this.onKeyUp=this.onKeyUp.bind(this),this.input=this.drawView(a),this.data={text:t.text||"",large:a},this.settings=[{name:"large",title:"Large",
...
i.addEventListener("click",(function(){e.toggleTune(a.name),i.classList.toggle("cdx-settings-button--active")})),e.api.tooltip.onHover(i,a.title,{placement:"top"})})),t}toggleTune(t){this.data[t]=!this.data[t],"stretched"==t&&this.api.blocks.stretchBlock(this.api.blocks.getCurrentBlockIndex(),this.data.stretched)}static get sanitize(){return{globs:!1,width:!1,height:!1}}}class AutomadSnippet{constructor({data:t}){var e=Automad.util.create;this.data={file:t.file||""},
