...
e(document).on("ajaxComplete",t.tags.init)}(window.Automad=window.Automad||{},jQuery,UIkit),function(t,e){t.textarea={selector:"textarea.am-u-form-controls:not([data-am-u-markdowneditor]), textarea.cdx-input",handleTabs:function(t){if(9===t.keyCode){t.preventDefault(),t.stopPropagation();var a=this.selectionStart,i=this.selectionEnd,o=e(t.target),n=o.val();o.val(n.substring(0,a)+"\t"+n.substring(i)),this.selectionStart=this.selectionEnd=a+1}},init:function(){
var a=t.textarea,i=e(document),o=function(){e(a.selector).trigger("update.automad.textarea")};i.on("keyup focus focusout update.automad.textarea",a.selector,a.resize),i.on("drop cut paste",a.selector,(function(t){var a=e(t.target);setTimeout((function(t){a.trigger("update.automad.textarea")}),50)})),i.ajaxComplete(o),i.on("ready",o),i.on("click",".am-u-accordion-title",(function(){setTimeout(o,50)})),e(window).resize(o),i.on("keydown",a.selector,a.handleTabs)},resize:function(t){
...
dataAttr:"data-am-toggle-default",update:function(e){e.closest("["+t.toggleDefault.dataAttr+"]").attr("data-selected",e.find(":selected").val())},init:function(){e("["+t.toggleDefault.dataAttr+"] select").each((function(){t.toggleDefault.update(e(this))}))}},e(document).on("change","["+t.toggleDefault.dataAttr+"] select",(function(a){t.toggleDefault.update(e(this))})),e(document).on("ready ajaxComplete",t.toggleDefault.init)}(window.Automad=window.Automad||{},jQuery),function(t,e,a){
e(document).on("ready ajaxComplete",(function(){setTimeout((function(){e("html.am-u-touch [data-am-u-tooltip]").removeAttr("data-am-u-tooltip")}),200)})),a.on("beforeready.uk.dom",(function(){e.extend(a.components.tooltip.prototype.defaults,{src:function(t){var e=t.attr("title");return void 0!==e&&(/mac/i.test(window.navigator.userAgent)&&(e=e.replace("Ctrl","⌘")),e=e.replace(/\[([^\]]+)\]/,"<div><small>$1</small></div>"),t.data("cached-title",e).removeAttr("title")),t.data("cached-title")}})}))
}(window.Automad=window.Automad||{},jQuery,UIkit),function(t,e){t.upload={dataAttr:{url:"data-am-url",dropzoneText:"data-am-dropzone-text",browseText:"data-am-browse-text"},selectors:{modal:"#am-upload-modal",container:"#am-upload-container"},$modal:"",$container:"",$close:"",page:"",$dropzone:e("<div></div>",{class:"am-files-dropzone am-u-hidden-touch"}),$input:e('<input type="file" multiple />'),$browse:e("<button></button>",{type:"button",
class:"am-u-button am-u-button-success am-u-button-large am-u-width-1-1 am-u-margin-small-top"}),init:function(a){var i=t.upload,o=t.util,n=i.dataAttr;i.$modal=e(i.selectors.modal),i.$container=e(i.selectors.container).empty(),i.page=i.$modal.data(o.dataCamelCase(n.url)),i.$dropzone.html('<i class="am-u-icon-arrows"></i>&nbsp;&nbsp;'+i.$modal.data(o.dataCamelCase(n.dropzoneText))).appendTo(i.$container),i.$input.appendTo(i.$dropzone).hide(),
i.$browse.html('<i class="am-u-icon-folder-open"></i>&nbsp;&nbsp;'+i.$modal.data(o.dataCamelCase(n.browseText))).insertAfter(i.$dropzone).click((function(){return t.upload.$input.click(),!1})),i.$close=i.$modal.find(".am-u-modal-close"),i.plugin(),e(i.selectors.modal).on("hide.uk.modal",{$filesForm:i.$modal.closest("form")},i.refresh)},plugin:function(){var a=t.upload;a.$input.fileupload({url:"?ajax=upload",dataType:"json",dropZone:a.$dropzone,sequentialUploads:!0,singleFileUploads:!0,formData:[{
name:"url",value:a.page}],add:function(i,o){var n="";e.each(o.files,(function(e){n+='<div class="am-text-white am-u-text-truncate">'+o.files[e].name+'</div><div class="am-u-text-small am-u-text-muted">'+t.util.formatBytes(o.files[e].size)+"</div>"})),o.context=e("<div></div>",{class:"am-u-margin-top"}).appendTo(a.$container),e(n).appendTo(o.context),e('<div class="am-u-progress am-u-progress-striped am-u-active"><div class="am-u-progress-bar"></div></div>').appendTo(o.context),
