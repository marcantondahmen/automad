 ...
 *	AUTOMAD
 *
 *	This block is based on the original table block of editor.js and
...
class AutomadTable {
	...
	static get toolbox() {
		return {
			icon: '<svg width="18px" height="15px" viewBox="0 0 18 15"><path d="M14,0H4C1.8,0,0,1.8,0,4v7c0,2.2,1.8,4,4,4h10c2.2,0,4-1.8,4-4V4C18,1.8,16.2,0,14,0z M4,2h4v4H2V4C2,2.9,2.9,2,4,2z M4,13 c-1.1,0-2-0.9-2-2V8h6v5H4z M16,11c0,1.1-0.9,2-2,2h-4V8h6V11z M16,6h-6V2h4c1.1,0,2,0.9,2,2V6z"/></svg>',
			title: 'Table',
		};
	}
