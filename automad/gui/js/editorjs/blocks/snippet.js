...
class AutomadBlockSnippet {
	...
	static get toolbox() {
		return {
			title: AutomadEditorTranslation.get('snippet_toolbox'),
	...
	constructor({data, api, config}) {
		...
		this.wrapper.innerHTML = `
			...
			<hr>
			${create.label(AutomadEditorTranslation.get('snippet_input'), ['am-block-label', 'uk-margin-top-remove']).outerHTML}
			${textarea.outerHTML}
			${create.label(AutomadEditorTranslation.get('snippet_file'), ['am-block-label']).outerHTML}
