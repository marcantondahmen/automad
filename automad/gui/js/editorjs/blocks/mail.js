...
class AutomadBlockMail {
	...
	constructor({data, api, config}) {
		...
		this.data = {
			...
			placeholderEmail: data.placeholderEmail || t('mail_data_placeholder_address'),
			placeholderSubject: data.placeholderSubject || t('mail_data_placeholder_subject'),
			placeholderMessage: data.placeholderMessage || t('mail_data_placeholder_message'),
		...
		this.inputs = {
			to: create.editable(['cdx-input'], t('mail_placeholder_address'), this.data.to),
			error: create.editable(['cdx-input'], t('mail_placeholder_error'), this.data.error),
			success: create.editable(['cdx-input'], t('mail_placeholder_success'), this.data.success),
		...
		this.wrapper.appendChild(create.label(t('mail_label_placeholder_address')));
		this.wrapper.appendChild(this.inputs.placeholderEmail);
		this.wrapper.appendChild(create.label(t('mail_label_placeholder_subject')));
		this.wrapper.appendChild(this.inputs.placeholderSubject);
		this.wrapper.appendChild(create.label(t('mail_label_placeholder_message')));
