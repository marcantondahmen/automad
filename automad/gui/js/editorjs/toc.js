...
class AutomadToc {
	...
	static get toolbox() {
		return {
			icon: '<svg width="18px" height="18px" viewBox="0 0 18 18" style="enable-background:new 0 0 18 18;"><path d="M14,6H4C3.45,6,3,5.55,3,5v0c0-0.55,0.45-1,1-1h10c0.55,0,1,0.45,1,1v0C15,5.55,14.55,6,14,6z"/><path d="M11,10H1c-0.55,0-1-0.45-1-1v0c0-0.55,0.45-1,1-1h10c0.55,0,1,0.45,1,1v0C12,9.55,11.55,10,11,10z"/><path d="M14,14H4c-0.55,0-1-0.45-1-1v0c0-0.55,0.45-1,1-1h10c0.55,0,1,0.45,1,1v0C15,13.55,14.55,14,14,14z"/><path d="M17,18H7c-0.55,0-1-0.45-1-1v0c0-0.55,0.45-1,1-1h10c0.55,0,1,0.45,1,1v0C18,17.55,17.55,18,17,18z"/><path d="M11,2H1C0.45,2,0,1.55,0,1v0c0-0.55,0.45-1,1-1l10,0c0.55,0,1,0.45,1,1v0C12,1.55,11.55,2,11,2z"/></svg>',
