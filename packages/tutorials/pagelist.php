				...
				<p class="control is-marginless">
					<div class="field has-addons">
						<p class="control">
							...
							class="button is-light<@ if not @{?filter} @> is-active<@ end @>">
								All
							</a>
						</p>
						...
						<@ foreach in filters @>
							<p class="control">
								...
								class="button is-light<@ if @{ ?filter } = @{ :filter } @> is-active<@ end @>">
				...
				<p class="control">
					<div class="field has-addons">
						<p class="control">
							...
							class="button is-light<@ if not @{?sort} or @{?sort} = 'date desc' @> is-active<@ end @>">
						...
						<p class="control">
							...
							class="button is-light<@ if @{?sort} = 'title asc' @> is-active<@ end @>"
							>
								<span class="icon is-small">
