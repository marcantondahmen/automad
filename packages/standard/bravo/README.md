...
The Bravo theme is a clean and elegant multi-purpose theme. It provides several options to display your content. Please read below more about the main concepts of this theme.
...
This theme includes two color schemes &mdash; a dark and a light one. By the default the dark color scheme is enabled. The `Light Color Scheme` checkbox can be used to apply the light color scheme to pages or even the whole site.
