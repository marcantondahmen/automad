...
<@ snippet main @>
	<main class="content uk-block">
		<p class="am-block uk-margin-top uk-margin-small-bottom">
		...
		<h1 class="am-block uk-margin-small-top uk-margin-large-bottom">
			404 
			&mdash;
			Page not found
		</h1>
		<div class="am-block uk-margin-large-bottom">
