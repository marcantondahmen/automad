...
<@ elements/header.php @>
	...
	<@ if not @{ checkboxHideFilters } @>
		<div class="uk-margin-large-top">
			<div class="am-two-buttons-stacked">
		...
		<@ foreach in pagelist @>
			<@ if @{ :i } = 1 @>
				<li class="am-msnry-item am-msnry-item-large uk-width-large-2-3">
					...
					<@ end @>
					<@ if @{ textTeaser } @>
						<div class="am-two-content uk-text-muted uk-text-large uk-margin-small-top">
							@{ textTeaser | markdown }
						</div>
					<@ end @>
			...
			<@ else @>
				<li class="am-msnry-item uk-width-small-1-2 uk-width-large-1-3">
					...
					<@ end @>
					<@ if @{ textTeaser } @>
						<div class="am-two-content uk-text-muted uk-margin-small-top">
							@{ textTeaser | markdown }
						</div>
					<@ end @>
